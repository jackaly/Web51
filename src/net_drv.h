...
#define ETHADDR3 0x19
#define ETHADDR4 0xBA
#define ETHADDR5 0xD8
...
#define     CR              XBYTE [0xc000]   /*	The command register (for all pages) */
#define     DMA_DATA		XBYTE [0xd100]	/*  Remote DMA Port10~17h (for all pages)*/
#define     RESET	        XBYTE [0xd800]	/*  Reset Port 18~1fh(for all pages)     */
...
#define     CLDA0		XBYTE [0xc100]   // Current Locat DMA 0: RD Low byte of current local dma addr
#define     PSTART      XBYTE [0xc100]	// Page Start:  WR Starting page of ring buffer      
#define     CLDA1		XBYTE [0xc200]   // Current Locat DMA 1:  RD High byte of current local dma add
#define     PSTOP  	    XBYTE [0xc200]	// Page Stop:  WR Ending page +1 of ring buffer     
#define     BNRY	    XBYTE [0xc300]	// Boundary Reg:  RD/WR Boundary page of ring buffer   
#define     TSR			XBYTE [0xc400]	// Transmit Status Reg: RD Transmit status reg               
#define     TPSR		XBYTE [0xc400]	// Transmit Page Start: WR Transmit starting page            
#define     NCR			XBYTE [0xc500]	// Number of Collision:  RD Number of collision reg           
#define     TBCR0  	    XBYTE [0xc500]	// Transmit Byte Count 0:  WR Low  byte of tx byte count        
#define     FIFO		XBYTE [0xc600]	// RD FIFO                              
#define     TBCR1		XBYTE [0xc600]	// Transmit Byte Count 1:  WR High byte of tx byte count        
#define     ISR			XBYTE [0xc700]	// Interrupt Status Reg:   RD/WR Interrupt status reg           
#define     CRDA0  	    XBYTE [0xc800]	// Current Remote DMA 0:  RD low byte of current remote dma add
#define     RSAR0		XBYTE [0xc800]	// Remote Start DMA 0:  WR Remote start address reg 0        
#define     CRDA1		XBYTE [0xc900]	// Current Remote DMA 1:  RD high byte, current remote dma add.
#define     RSAR1		XBYTE [0xc900]	// Remote Start DMA 1:  WR Remote start address reg 1        
#define     RBCR0	    XBYTE [0xca00]	// Remote Byte Count 0:  WR Remote byte count reg 0           
#define     R8019ID0	XBYTE [0xca00]	// Only 8019AS                          
#define     RBCR1		XBYTE [0xcb00]	// Remote Byte Count 1:  WR Remote byte count reg 1           
#define     R8019ID1 	XBYTE [0xcb00]	// Only 8019AS                          
#define     RSR			XBYTE [0xcc00]	// Reciever Status Reg:  RD RX status reg                     
#define     RCR		    XBYTE [0xcc00]	// Reciever Configuration Reg:  WR RX configuration reg              
#define     TCR		    XBYTE [0xcd00]	// Transmit Configuration Reg:  WR TX configuration reg              
#define     CNTR0	    XBYTE [0xcd00]	// RD Rcv alignment error counter       
#define     DCR		    XBYTE [0xce00]	// Data Configuration Reg:  WR Data configuration reg            
#define     CNTR1	    XBYTE [0xce00]	// RD Rcv CRC error counter             
#define     IMR			XBYTE [0xcf00]	// Interrupt Mask Reg:  WR Interrupt mask reg                
#define     CNTR2	    XBYTE [0xcf00]	// RD Rcv missed frame error counter    
...
#define     PAR0	    XBYTE [0xc100]	// RD/WR This board's physical ethernet addr */
#define     PAR1	    XBYTE [0xc200]
#define     PAR2	    XBYTE [0xc300]
#define     PAR3	    XBYTE [0xc400]
#define     PAR4	    XBYTE [0xc500]
#define     PAR5	    XBYTE [0xc600]
#define     CURR	    XBYTE [0xc700]   // RD/WR current page reg */
//#define		EN1_CURPAG		EN1_CURR
#define     MAR0        XBYTE [0xc800]   // RD/WR Multicast filter mask array (8 bytes) */
#define     MAR1		XBYTE [0xc900]
#define     MAR2        XBYTE [0xca00]
#define     MAR3        XBYTE [0xcb00]
#define     MAR4        XBYTE [0xcc00]
#define     MAR5        XBYTE [0xcd00]
#define     MAR6        XBYTE [0xce00]
#define     MAR7        XBYTE [0xcf00]

/* Page 2 register offsets                                                   */
#define     STARTPG_R     XBYTE [0xc100]   // RD only Reg.           
#define     STOPPG_R      XBYTE [0xc200]
#define     TPSR_R		  XBYTE [0xc400]
#define     RXCR_R		  XBYTE [0xcc00]
#define     TXCR_R		  XBYTE [0xcd00]
#define     DCR_R		  XBYTE [0xce00]
#define     IMR_R	      XBYTE [0xcf00]
...
extern void rtl8019_init(void);
extern void send_packet(unsigned char *buf, unsigned int length) ;
extern unsigned int recv_packet(unsigned char *buf);
